...
subj = {'1R45CWW_S65','1R45CWW_D3','1R45AWW_S66','1R45AWW_D4','1R45AWW_D5',... %%%%% Single cursor condition (no landmarks)
    ...
    '1R45AWL_S9','1R45AWL_S10','1R45AWL_K4','1R45AWL_S11','1R45AWL_K2',... %%%%% Single cursor condition (WITH landmarks & Aim report)
    '1R45AWL_K6','1R45CWL_S3','1R45CWL_S5','1R45CWL_K1','1R45CWL_S8',...
    '1R45CWL_K3','1R45CWL_K5',...
    'EN45CGP_K5','EN45AGP_K9','EN45COG_K7','EN45AOG_K6','EN45COP_K10',... %%%%% ME 3 cursor aim report
    'EN45AOP_K8','EN45CPG_K11','EN45APG_K12','EN45CPO_K13','EN45APO_K14',...
    'EN45CGO_K15','EN45AGO_K16'};
...
% print(sprintf('%sFig3Comparison1',figDir),'-painters','-dpdf')

dpPlot_compareGroups(allGrpMean,allGrpSEM,genGrpMean, genGrpSEM, [3 4], fr.col)
% print(sprintf('%sFig3Comparison2',figDir),'-painters','-dpdf')

dpPlot_compareGroups(allGrpMean,allGrpSEM,genGrpMean, genGrpSEM, [2 3], fr.col)
% print(sprintf('%sFig3Comparison3',figDir),'-painters','-dpdf')
...
% -----------------------------------------------------
% Mean Aftereffect ttest between to see if significant AE at training tgt
dpPrintTtest1(genSubjMean(train_idx,:), fr.group_names, 3, 'AE')

% -----------------------------------------------------
% Mean Aftereffect ttest between to see if significant AE at training tgt
dpPrintTtest1(genSubjMean(train_idx,:), fr.group_names, 4, 'AE')
